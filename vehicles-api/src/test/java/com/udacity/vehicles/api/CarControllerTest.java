...
public class CarControllerTest {
    ...
    public void putCar() throws Exception {
        ...
        mvc.perform( MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("details.fuelType").value("Petrol"))
                .andExpect(MockMvcResultMatchers.jsonPath("details.body").value("hatchback"));
    }
